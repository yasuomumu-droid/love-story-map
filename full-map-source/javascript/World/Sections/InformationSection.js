...
export default class InformationSection
{
    ...
    setLinks()
    {
        ...
        this.links.options = [
            {
                title: 'Instagram',
                href: 'https://www.instagram.com/annivaembe/',
                displayHref: 'instagram.com/annivaembe',
                labelTexture: this.resources.items.informationContactTwitterLabelTexture
            },
            {
                title: 'YouTube',
                href: 'https://www.youtube.com/@meichanvathegioikythu',
                displayHref: 'youtube.com/@meichanvathegioikythu',
                labelTexture: this.resources.items.informationContactGithubLabelTexture
            },
            {
                title: 'TikTok',
                href: 'https://www.tiktok.com/@meichanvathegioikythu?is_from_webapp=1&sender_device=pc',
                displayHref: 'tiktok.com/@meichanvathegioikythu',
                labelTexture: this.resources.items.informationContactLinkedinLabelTexture
            },
            {
                title: 'Mail',
                href: 'mailto:duyentung225@gmail.com',
                displayHref: 'duyentung225@gmail.com',
        ...
        for(const _option of this.links.options)
        {
            ...
            item.title = _option.title
            item.href = _option.href
            item.displayHref = _option.displayHref
            ...
            {
                window.dispatchEvent(new CustomEvent('love-story:open', {
                    detail: {
                        eyebrow: 'LIÊN KẾT',
                        title: item.title,
                        linkHref: item.href,
                        linkLabel: item.displayHref
                    }
                }))
            })
