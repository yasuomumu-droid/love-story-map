...
export default class IntroSection
{
    ...
    setTitles()
    {
        // Title: the GLB files are centred, so the complete "TUNG DUYEN" layout
        // stays editable here without having to move individual meshes in Blender.
        const titleResources = {
            T: { base: this.resources.items.introTBase.scene, collision: this.resources.items.introTCollision.scene },
            U: { base: this.resources.items.introUBase.scene, collision: this.resources.items.introUCollision.scene },
            N: { base: this.resources.items.introNBase.scene, collision: this.resources.items.introNCollision.scene },
            G: { base: this.resources.items.introGBase.scene, collision: this.resources.items.introGCollision.scene },
            D: { base: this.resources.items.introDBase.scene, collision: this.resources.items.introDCollision.scene },
            Y: { base: this.resources.items.introYBase.scene, collision: this.resources.items.introYCollision.scene },
            E: { base: this.resources.items.introEBase.scene, collision: this.resources.items.introECollision.scene }
        }
        const titleLetters = [
            { key: 'T', x: - 4.40 },
            { key: 'U', x: - 3.35 },
        ...
        {
            const resource = titleResources[letter.key]

            this.objects.add({
                base: resource.base,
                collision: resource.collision,
                offset: new THREE.Vector3(letter.x, - 9.47, 0.02),
                rotation: new THREE.Euler(0, 0, 0),
                duplicated: true,
